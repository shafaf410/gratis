...
export default function GratisHomepage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] text-white selection:bg-[#D9233E] selection:text-white overflow-x-hidden">
      {/* ==================== 1. HEADER (CARBON BLACK) ==================== */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="flex items-center gap-1.5">
              <span className="font-display text-3xl font-extrabold tracking-tighter uppercase text-white">
                GRATIS
              </span>
              {/* Architectural Three Diagonal Red Chevrons */}
          ...
          {/* Strategic Red CTA Button */}
          <div className="hidden md:flex items-center space-x-4">
            <a
              href="#contact"
              className="bg-[#D9233E] hover:bg-[#B51B32] text-white px-6 py-3 text-xs font-mono font-bold uppercase tracking-widest rounded-none transition-all duration-300 flex items-center gap-2 group shadow-lg"
            >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-0 z-40 bg-[#0B0B0B] text-white pt-24 px-8 flex flex-col justify-between pb-12 lg:hidden overflow-y-auto"
          >
            <div className="space-y-4">
              ...
              {[
                ...
                <button
                  ...
                  className="block w-full text-left font-display text-2xl uppercase tracking-wide py-3 border-b border-white/10 hover:text-[#D9233E]"
                >
                  {item.label}
                </button>
              ))}
      ...
      {/* ==================== 2. DRAMATIC HERO SECTION (CARBON BLACK) ==================== */}
      <section className="relative w-full min-h-screen bg-[#0B0B0B] text-white pt-28 pb-16 flex items-center overflow-hidden border-b border-white/10">
        {/* Oversized Background Chevron Graphic Motif */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none select-none opacity-20 hidden lg:block">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-[#1A1A1A] border-l-2 border-[#D9233E] text-xs font-mono tracking-widest text-white/90 uppercase font-bold">
            ...
            <p className="text-base md:text-lg text-white/70 font-normal leading-relaxed max-w-xl">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-5">
              ...
              <a
                href="#about"
                className="border border-white/20 hover:border-white text-white px-6 py-4 text-xs font-mono font-bold uppercase tracking-widest rounded-none transition-all duration-300 flex items-center justify-center gap-2"
              >
          ...
          {/* Right Column: Architectural Photography + Partially Cropped Chevrons */}
          <div className="lg:col-span-5 relative">
            <div className="relative z-10 overflow-hidden border border-white/10 bg-[#1A1A1A] group">
              <img
                src="/hero-living-space.jpg"
                alt="GRATIS Architectural Masterpiece"
                className="w-full h-[500px] md:h-[580px] object-cover grayscale contrast-125 group-hover:grayscale-0 transition-all duration-700"
              />
              {/* Overlay Partially Cropped Chevrons */}
              <div className="absolute top-0 right-0 bottom-0 w-36 bg-gradient-to-l from-black/90 via-black/40 to-transparent pointer-events-none flex items-center justify-end pr-4">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-[#0B0B0B]/90 p-4 border-t border-white/10">
      ...
      {/* ==================== 3. SECTION TRANSITION 1: STATEMENT BAR (OFF-WHITE #F5F4F0) ==================== */}
      <section className="w-full py-16 bg-[#F5F4F0] text-[#0B0B0B] border-b border-[#E5E5E5]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={index}
              className="p-6 bg-white border border-[#E5E5E5] hover:border-[#D9233E] transition-colors space-y-3 relative group"
            >
      ...
      {/* ==================== 4. SECTION TRANSITION 2: LEADERSHIP / CHAIRMAN (CHARCOAL #1A1A1A) ==================== */}
      {(activeSection === "all" || activeSection === "chairman") && (
        <section id="chairman" className="py-24 bg-[#1A1A1A] text-white border-b border-white/10">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-[#0B0B0B] p-8 md:p-14 border border-white/10 relative">
              {/* Red Vertical Accent Line */}
              <div className="absolute top-0 bottom-0 left-0 w-1 bg-[#D9233E]" />

              <div className="lg:col-span-4 relative">
                <div className="relative border border-white/10 bg-[#1A1A1A] overflow-hidden">
                  <img
                  ...
                  />
                  <div className="absolute bottom-0 inset-x-0 bg-black/90 p-4 border-t border-white/10">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                <h3 className="font-display text-4xl md:text-5xl font-extrabold text-white tracking-tight uppercase leading-none">
                  &quot;OUR VISION IS A BETTER TOMORROW&quot;
                </h3>

                <div className="space-y-4 text-sm text-white/80 font-normal leading-relaxed">
                  <p>
                ...
                <div className="pt-4 border-t border-white/10 text-xs font-mono uppercase tracking-widest text-[#D9233E] font-bold">
      ...
      {/* ==================== 5. SECTION TRANSITION 3: ABOUT GRATIS GROUP (PURE WHITE #FFFFFF) ==================== */}
      {(activeSection === "all" || activeSection === "about") && (
        <section id="about" className="py-24 bg-white text-[#0B0B0B] border-b border-[#E5E5E5]">
          <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-6 relative">
                <div className="overflow-hidden border border-[#E5E5E5] relative shadow-md">
                  <img
                    ...
                    className="w-full h-[500px] object-cover grayscale contrast-125 hover:grayscale-0 transition-all duration-700"
                  />
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <div className="space-y-4 text-sm text-[#444444] leading-relaxed bg-[#F5F4F0] p-6 border border-[#E5E5E5]">
                  ...
                  <div className="text-xs text-[#0B0B0B] font-mono border-l-2 border-[#D9233E] pl-3 py-1.5 bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Mission Panel (Off-White #F5F4F0) */}
              <div className="bg-[#F5F4F0] border border-[#E5E5E5] p-8 md:p-12 space-y-4 relative">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono uppercase tracking-widest text-[#D9233E] font-bold">
                    PURPOSE & DRIVE
                  </span>
              ...
              {/* Vision Panel (Carbon Black #0B0B0B) */}
              <div className="bg-[#0B0B0B] text-white border border-white/10 p-8 md:p-12 space-y-4 relative">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono uppercase tracking-widest text-[#D9233E] font-bold">
                    GLOBAL DIRECTION
                  </span>
      ...
      {/* ==================== 6. SECTION TRANSITION 4: BUSINESS VERTICALS (LARGE INDUSTRIAL GRID IN CARBON BLACK #0B0B0B) ==================== */}
      {(activeSection === "all" || activeSection === "verticals") && (
        <section id="verticals" className="py-24 bg-[#0B0B0B] text-white border-b border-white/10 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-16">
            <div className="space-y-3">
              <span className="text-xs font-mono uppercase tracking-widest text-[#D9233E] font-bold">
                CONGLOMERATE STRUCTURE
              </span>
              <h2 className="font-display text-4xl md:text-6xl font-extrabold text-white tracking-tight uppercase leading-none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-7 bg-[#1A1A1A] p-8 md:p-12 border-l-4 border-[#D9233E] relative overflow-hidden flex flex-col justify-between space-y-8">
                <div className="space-y-4">
                  <span className="px-3 py-1 bg-[#D9233E] text-white text-xs font-mono uppercase font-bold tracking-widest inline-block">
                    ★ FLAGSHIP VERTICAL
                  </span>
                  <h3 className="font-display text-3xl md:text-5xl font-extrabold text-white uppercase leading-none">
                    WOODMALL — <br />
              ...
              <div className="lg:col-span-5 grid grid-cols-1 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="bg-[#1A1A1A] p-5 border border-white/10 hover:border-[#D9233E] transition-colors flex items-start gap-4 group"
                  >
                    <span className="font-mono text-xl font-extrabold text-[#D9233E]">
                      {item.num}
                    </span>
                    <div>
                      <h4 className="font-display text-base font-bold uppercase tracking-tight text-white group-hover:text-[#D9233E] transition-colors">
      ...
      {/* ==================== 7. SECTION TRANSITION 5: PRODUCTS RANGE (OFF-WHITE #F5F4F0) ==================== */}
        ...
        <section id="products" className="py-24 bg-[#F5F4F0] text-[#0B0B0B] border-b border-[#E5E5E5]">
          <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-7 group relative h-[500px] border border-[#E5E5E5] overflow-hidden bg-[#0B0B0B]">
                <img
                ...
                <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end text-white space-y-2">
                  ...
                  <p className="text-xs text-white/70 font-normal max-w-md leading-relaxed">
              ...
              <div className="lg:col-span-5 grid grid-cols-1 gap-8">
                {[
                  ...
                  <div
                    key={idx}
                    className="group relative h-[236px] border border-[#E5E5E5] overflow-hidden bg-[#0B0B0B]"
                  >
                    <img
                      src={card.img}
                      alt={card.title}
      ...
      {/* ==================== 8. SECTION TRANSITION 6: HUGE NUMERICAL STATISTICS (CARBON BLACK #0B0B0B) ==================== */}
      <section className="py-24 bg-[#0B0B0B] text-white border-b border-white/10 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-16">
          <div className="space-y-3">
            <span className="text-xs font-mono uppercase tracking-widest text-[#D9233E] font-bold">
              PROVEN PERFORMANCE
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-left">
            {[
              ...
              <div key={idx} className="border-t border-[#D9233E] pt-6 space-y-2">
                <p className="font-display text-5xl md:text-6xl font-extrabold text-[#D9233E] tracking-tight">
                  {s.stat}
                </p>
                <p className="text-xs font-mono uppercase tracking-wider text-white/80 font-bold">
                  {s.label}
                </p>
              </div>
            ))}
      ...
      {/* ==================== 9. SECTION TRANSITION 7: DRAMATIC CTA BANNER (CARBON BLACK #0B0B0B + OVERSIZED CHEVRONS) ==================== */}
      <section className="py-28 bg-[#0B0B0B] text-white border-b border-white/10 relative overflow-hidden">
        {/* Oversized Chevrons Emerging from Right Edge */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none select-none opacity-25">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-8 relative z-10">
          ...
          <p className="text-base md:text-lg text-white/70 max-w-xl font-normal leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-5">
            ...
            <a
              ...
              className="border border-white/20 hover:border-white text-white px-8 py-4 text-xs font-mono font-bold uppercase tracking-widest rounded-none transition-all duration-300 flex items-center justify-center gap-2"
            >
      ...
      {/* ==================== 10. SECTION TRANSITION 8: CONTACT FORM (OFF-WHITE #F5F4F0) ==================== */}
      ...
      {/* ==================== 11. FOOTER (CARBON BLACK #0B0B0B) ==================== */}
      <footer className="bg-[#0B0B0B] text-white border-t border-white/10 pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-12">
          ...
          <div className="pt-8 border-t border-[#D9233E]/30 flex flex-col sm:flex-row items-center justify-between text-xs text-white/40">
            <p>© {new Date().getFullYear()} GRATIS Group of Companies. All rights reserved.</p>
            <p className="font-mono text-[#D9233E]">GRATIS — WE ARE BEHIND ALL THAT&apos;S BEAUTIFUL.</p>
          </div>
        </div>
      </footer>
    </div>
